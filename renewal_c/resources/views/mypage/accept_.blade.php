...
{{include('header.html')}}
	<div class="container">
		<div id="mainContent">
			...
			<div style="line-height:0;"><a href="https://www.epark.jp/campaign/family/kosodate?utm_source=www.docknet.jp&utm_medium=banner&utm_campaign=201710premium_children&utm_content=mypage&utm_term=20180329" target="_blank"><img src="https://www.epark.jp/event/family/forDev/mtm_kosodate_1200_60.png" alt="EPARKは子育てをがんばるママを応援！ EPARKの子育て割 対象は9サービス！" style="width:100%;"></a></div>

			<article id="mypage">
				<h1 class="mTitle">{{ display_name }}さんのマイページ</h1>
				<ul class="tab">
					<li><a href="/mypage/">マイページトップ</a></li><li class="current"><a href="/mypage/accept.html">予約履歴</a></li><li><a href="/mypage/favorite.html">お気に入り</a></li><li><a href="/mypage/information.html">会員情報</a></li>
				</ul>
					...
					<section>
						...
						<dl class="list">
							...
							<dd>
								...
								<ul class="cate sm" style="display:none;">
									{{ BEGIN course_icon }}
									<li>{{ icon_name }}</li>
									{{ END }}
								</ul>
								<ul class="cate sm gr" style="display:none;">
								...
								{{ IF payment_flg == '1' }}
									<!--事前決済-->
									<p class="right"><a href="{{ alive }}" class="delete">キャンセル</a></p>
								{{ ELSE IF }}
									<!--現地決済-->
									<p class="right"><a href="{{ alive }}" class="delete">キャンセル・予約内容の変更</a></p>
								{{ END IF }}
										...
										<li>
											...
											<div class="modalWindow ssRating" style="display:none;">
												<div>
													...
													<div class="orangeBtn01" value="3" data-history='{{ history }}'>送信する</div>
										...
										<li>
											...
											<div class="modalWindow ssRating" style="display:none;">
												<div>
													...
													<div class="close">閉じる</div>
													<div class="close">閉じる</div>
													<div class="orangeBtn01" value="2" data-history='{{ history }}'>送信する</div>
													<div class="grayBtn01">口コミにも投稿する</div>
												</div>
											<!-- /.modalWindow --></div>
										</li>
										...
										<li>
											...
											<div class="modalWindow ssRating" style="display:none;">
												<div>
													...
													<div class="close">閉じる</div>
													<div class="close">閉じる</div>
													<div class="orangeBtn01" value="1" data-history='{{ history }}'>送信する</div>
													<div class="grayBtn01">口コミにも投稿する</div>
												</div>
											<!-- /.modalWindow --></div>
										</li>
			...
			<script id="script_loader" type="text/javascript" src="{{ API_COUPON }}/js/script_loader/pc_mypage_src_loader.js"></script>
		</div>
	</div><!-- .container -->
{{include('footer.html')}}
</body>
